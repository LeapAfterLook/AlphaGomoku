...
def max_pool_3x3(value):
    return tf.nn.max_pool(value=value, ksize=[1, 3, 3, 1], strides=[1, 3, 3, 1], padding='SAME')
...
# 2nd conv layer
W_conv2 = weight_variable("W_conv2", [3, 3, 1024, 256])
...
# 1st fc layer
W_fc1 = weight_variable("W_fc1", [5 * 5 * 128, 1024])
